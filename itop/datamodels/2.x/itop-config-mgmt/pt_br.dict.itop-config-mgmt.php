...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Class:Server/Attribute:logicalvolumes_list+' => 'Todos os volumoes lógicos vinculados para esse equipamento',
));
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Class:Hypervisor/Attribute:server_id' => 'equipamento',
	'Class:Hypervisor/Attribute:server_id+' => '',
	'Class:Hypervisor/Attribute:server_name' => 'Nome equipamento',
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Class:LogicalVolume/Attribute:servers_list' => 'equipamentoes',
	'Class:LogicalVolume/Attribute:servers_list+' => 'Todos os equipamentoes usando esse volume',
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	'Class:lnkServerToVolume' => 'Link equipamento / Volume',
	'Class:lnkServerToVolume+' => '',
	...
	'Class:lnkServerToVolume/Attribute:server_id' => 'equipamento',
	'Class:lnkServerToVolume/Attribute:server_id+' => '',
	'Class:lnkServerToVolume/Attribute:server_name' => 'Nome equipamento',
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Class:OSLicence/Attribute:servers_list' => 'equipamentoes',
	'Class:OSLicence/Attribute:servers_list+' => 'Todos os equipamentoes onde essa licença é usada',
));
...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Class:Model/Attribute:type/Value:SANSwitch+' => 'Switch SAN',
	'Class:Model/Attribute:type/Value:Server' => 'equipamento',
	'Class:Model/Attribute:type/Value:Server+' => 'equipamento',
...
'Menu:Server' => 'equipamentoes',
'Menu:Server+' => 'Todos equipamentoes',
