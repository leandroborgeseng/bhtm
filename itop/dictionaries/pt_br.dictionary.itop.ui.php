...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'BooleanLabel:no' => 'Não',
	'Menu:WelcomeMenu' => 'Bem-vindo', // Duplicated into itop-welcome-itil (will be removed from here...)
	'Menu:WelcomeMenu+' => 'Bem-vindo', // Duplicated into itop-welcome-itil (will be removed from here...)
	'Menu:WelcomeMenuPage' => 'Bem-vindo', // Duplicated into itop-welcome-itil (will be removed from here...)
	'Menu:WelcomeMenuPage+' => 'Bem-vindo', // Duplicated into itop-welcome-itil (will be removed from here...)
	'UI:WelcomeMenu:Title' => 'Bem-vindo',

	'UI:WelcomeMenu:LeftBlock' => '<p>bHTM é um completo, OpenSource, portal de operação IT.</p>
<ul>Inclui:
...
<li>gerenciar o ativo mais importante de sua TI: Documentação</li>
	...
	'UI:Error:UploadedFileTooBig' => 'O arquivo a ser carregado é muito grande. (Tamanho máximo permitido é de %1$s). Para modificar esse limite, contate o administrador do bHTM. (Verifique a configuração do PHP para upload_max_filesize e post_max_size no servidor).',
	...
	'UI:Login:Welcome' => 'Bem-vindo ao bHTM!',
	...
	'UI:Login:ForgotPwdForm+' => 'bHTM pode enviar um e-mail em que você vai encontrar instruções para seguir para redefinir sua conta.',
	...
	'UI:ResetPwd-EmailBody' => '<body><p>Você solicitou a alteração da senha do bHTM.</p><p>Por favor, siga este link (passo simples) para <a href="%1$s">digitar a nova senha</a></p>.',
	...
	'UI:CSVExport:LostChars+' => 'The downloaded file will be encoded into %1$s. bHTM has detected some characters that are not compatible with this format. Those characters will either be replaced by a substitute (e.g. accentuated chars losing the accent), or they will be discarded. You can copy/paste the data from your web browser. Alternatively, you can contact your administrator to change the encoding (See parameter \'csv_file_default_charset\').',
...
When associated with a trigger, each action is given an "order" number, specifying in which order the actions are to be executed.</p>',
	...
	'Portal:NoRequestMgmt' => 'Caro %1$ s, você foi redirecionado para esta página porque a sua conta é configurado com o perfil de \'usuário do Portal\'. Infelizmente, bHTM não foi instalado com a função \'Gerenciamento de Solicitações\'. Por favor, contate o administrador.',
...
'Note-se que esta não é uma configuração de segurança, objetos de qualquer organização ainda são visíveis e podem ser acessadas ao selecionar \"Todos Organizações\" na lista drop-down.',
	...
	'Class:UserInternal+' => 'User defined within bHTM~~',
	...
	'UI:AboutBox' => 'About bHTM...~~',
	'UI:About:Title' => 'About bHTM~~',
